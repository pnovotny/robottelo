...
def test_positive_search_by_reported_data(target_sat, rhel_contenthost, module_org, module_ak):
    """
    ...
    :customerscenario: true
    """
    rhel_contenthost.register(module_org, None, module_ak.name, target_sat)
